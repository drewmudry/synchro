    ...
    <div className="bg-[#F5EBDE] min-h-screen">
      ...
      <main className="container mx-auto px-8 py-16">
        <section className="mb-16">
          ...
          <p className="text-xl text-[#AE808B] mb-8">
            Collaborative whiteboard app for seamless teamwork.
          </p>
          <Link href="/about-boards" className="bg-[#661438] text-white px-6 py-3 rounded-md">
            Learn More
          </Link>
        </section>
        ...
        <section className="mb-16">
          ...
          <Link href="/about-tasks" className="bg-[#661438] text-white px-6 py-3 rounded-md">
            Learn More
          </Link>
        </section>
        ...
        <section>
          ...
          <Link href="/about-notes" className="bg-[#661438] text-white px-6 py-3 rounded-md">
            Learn More
          </Link>
        </section>
      </main>
